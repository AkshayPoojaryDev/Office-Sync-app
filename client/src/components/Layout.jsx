            ...
            {navigation.map((item) => (
              <Link
                ...
                className={`group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors duration-150 ${isActive(item.path)
                    ...
                    : 'text-gray-700 hover:bg-gray-50 hover:text-[#486581]'
                  }`}
              >
                <span className={`mr-3 flex-shrink-0 ${isActive(item.path) ? 'text-[#486581]' : 'text-gray-400 group-hover:text-[#486581]'}`}>
                  {item.icon}
                </span>
                {item.name}
              </Link>
          ...
          <div className="flex-shrink-0 border-t border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <button
                ...
                className="ml-2 flex-shrink-0 p-2 text-gray-400 hover:text-red-600 transition-colors"
                title="Sign out"
              >
